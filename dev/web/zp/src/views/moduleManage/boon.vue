/*
 * @Author: zhough 
 * @Date: 2019-12-28 22:52:49 
 * @Last Modified by: zhough
 * @Last Modified time: 2019-12-29 10:47:27
 */
<template>
  <div id="moduleBoon">
    <div class="tableDiv">

      <el-input style="width:200px" v-model="input" placeholder="请输入要查找的内容"></el-input>

      <el-table ref="multipleTable" :data="WelfareList" tooltip-effect="dark" style="width: 90%" @selection-change="selectionChange">
        ...
        <el-table-column align="center" label="操作" width="100">
          <template slot-scope="scope">
            ...
            <el-button size="mini" type="success" @click="changeStatus_1(scope.row)" plain>使用</el-button>
            <el-button size="mini" type="danger" @click="changeStatus_2(scope.row)" plain>冻结</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div>
